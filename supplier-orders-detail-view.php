<?php
include"tdb.php";
$result = $conn->query("SELECT t.sno as sno,t.PROD_TYPE as ptype,t.trans_type as trans_type,t.QUANTITY as QUANTITY,t.DEL_TIME as DEL_TIME,t.DEL_STATUS as status,t.FROM_DATE as fdate,t.TO_DATE as tdate,t.PROD_ID as pid,p.PROD_NAME as pname,p.IMAGE as image FROM daily_transaction t,products p where t.PROD_ID=p.id and t.CONS_ID='".$_GET['cid']."' and t.PROD_ID='".$_GET['pid']."' and t.SUPP_ID='".$_GET['id']."' and t.g_id='".$_GET['gid']."' order by t.FROM_DATE asc");
$outp = "";
$old="";
$orginal=array();
$from_date=array();
...
$date=date('h:i a', strtotime($date));
if($neworder['tdate'][$a]>$neworder['fdate'][$a])
{
